...
- **주요 내용**: 본 문서는 Orchestrator — Complete Governance & Execution System 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
...
1. CLAUDE.md (root)
   ...
   └─ Import chain (read these first)
       ...
       ├─ mcp-registry.md (classified MCP connections)
...
### **MCP Registry**
- **What**: classified MCP connections with separation of Core / Optional / Remove-Candidate / On-demand
