...
> **Purpose**: **Single source of truth** for all projects, teams, skills, and operations. Eliminate duplication. Maximum visibility. Minimal friction.
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 MASTER SYSTEM — Unified Organization Framework 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
