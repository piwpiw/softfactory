...
→ Read: `docs/PERFORMANCE_REPORT.md` Section 4 OR `../../runbooks/PERFORMANCE_TESTING_GUIDE.md`

**...implement optimizations**
→ Follow: `../../runbooks/PERFORMANCE_TESTING_GUIDE.md` (Week 1, 2, 3 sections)
...
A: `profiler.py` for testing, `performance_report_generator.py` for analysis, `../../runbooks/PERFORMANCE_TESTING_GUIDE.md` for implementation.

**Q: What if something breaks?**
A: See troubleshooting section in `docs/PERFORMANCE_REPORT.md` or `../../runbooks/PERFORMANCE_TESTING_GUIDE.md`.
...
- **Implementation Steps**: `../../runbooks/PERFORMANCE_TESTING_GUIDE.md`
