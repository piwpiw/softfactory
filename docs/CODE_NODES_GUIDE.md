...
> **Purpose**: Custom Code Nodes are a powerful feature of AI Automation that allows advanced users to write and execute custom JavaScript code in a secure sandbox e...
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 Custom JavaScript Code Nodes Guide 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
