...
> **Purpose**: **Purpose:** Single universal checklist for validating all project deliverables across all phases and agents. Use this to catch issues early.
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 Cross-Validation Checklist (Master Template) 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
