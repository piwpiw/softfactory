...
> **Purpose**: Complete RBAC system for granular access control across the SoftFactory platform. Implements role-based and permission-based access control with compr...
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 Role-Based Access Control (RBAC) Implementation 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
