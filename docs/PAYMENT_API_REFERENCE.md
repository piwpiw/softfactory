...
> **Purpose**: The enhanced payment system provides comprehensive features for international transactions, invoice management, and flexible subscription billing.
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 Payment System API Reference v2.0 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
