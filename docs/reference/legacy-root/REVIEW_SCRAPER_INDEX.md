...
> **Purpose**: **프로젝트:** Review Listing Aggregator (5개+ 플랫폼 통합 리뷰 리스팅 스크래퍼)
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 Review Scraper - 문서 색인 (Document Index) 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
...
📄 **`../../status/REVIEW_SCRAPER_PROJECT_STATUS.txt`** (13KB)
- 프로젝트 상태 한눈에 보기
- 요구사항 충족도 (10/10)
- 배포 체크리스트
- 빠른 배포 가이드 (4단계)
...
📄 **`../../archive/root-legacy/REVIEW_SCRAPER_SUMMARY.md`** (10KB)
- Executive summary
- 성능 메트릭
- 비용-효과 분석
- 유지보수 계획

📄 **`../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md`** (19KB) ⭐ **가장 상세한 분석**
...
📄 **`../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md`** (17KB) ⭐ **배포 담당자 필독**
- 빠른 시작 (2단계)
- 플랫폼별 구현 체크리스트 (8개)
...
1. `../../status/REVIEW_SCRAPER_PROJECT_STATUS.txt` 읽기 (5분)
2. `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - Step 1-2 (1시간)
3. `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - Step 3-4 (1시간)

### 케이스 2: "기술적으로 자세히 이해하고 싶어요"
**예상 시간: 1-2시간**

1. `../../archive/root-legacy/REVIEW_SCRAPER_SUMMARY.md` 읽기 (15분)
2. `../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md` 읽기 (45분)
3. `backend/services/review_scrapers/README.md` 읽기 (20분)

### 케이스 3: "문제를 해결해야 해요"
**예상 시간: 30분**

1. `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "🚨 에러 처리 및 로깅" 섹션
2. `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "📞 문제 해결" 섹션
3. 해당 스크래퍼 파일 확인

### 케이스 4: "유지보수 계획을 수립하고 싶어요"
**예상 시간: 30분**

1. `../../archive/root-legacy/REVIEW_SCRAPER_SUMMARY.md` - "🔄 유지보수 계획" 섹션
2. `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "🔄 유지보수 가이드" 섹션
...
→ `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "CSS Selector 검증" 섹션 참고
...
→ `../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md` - "성능 분석" 섹션 참고

### Q4: "8개 플랫폼이 필요한가요?"
**A:** 최소 5개만 필요하지만, 8개 모두 제공됩니다. 필요없는 것은 비활성화 가능합니다.
→ `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "성능 최적화" 섹션 참고

### Q5: "에러가 발생하면?"
**A:** 3회 자동 재시도 + 상세 로깅이 있습니다.
→ `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "문제 해결" 섹션 참고
...
### 초급 (30분)
1. `../../status/REVIEW_SCRAPER_PROJECT_STATUS.txt` 읽기
2. `../../archive/root-legacy/REVIEW_SCRAPER_SUMMARY.md` 읽기
3. `/backend/services/review_scrapers/README.md` 훑어보기

### 중급 (1시간)
1. `../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md` - 아키텍처 섹션
2. `base_scraper.py` 코드 읽기
3. 한 개 플랫폼 scraper 읽기

### 고급 (2시간)
1. `../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md` 전체
2. 모든 플랫폼 scraper 코드
...
### 지금 할 일
1. `../../status/REVIEW_SCRAPER_PROJECT_STATUS.txt` 읽기
2. `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - Step 1-2 실행
3. 각 플랫폼 HTML 구조 검증
...
### 기술 문제
→ `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "📞 문제 해결" 섹션

### 배포 관련
→ `../../runbooks/REVIEW_SCRAPER_IMPLEMENTATION_GUIDE.md` - "🚀 빠른 배포 가이드" 섹션

### 성능 최적화
→ `../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md` - "성능 분석" 섹션

### 아키텍처 이해
→ `../../archive/root-legacy/REVIEW_SCRAPER_ANALYSIS.md` - "현황 분석" 섹션
