...
> **Purpose**: Complete Elasticsearch implementation for SoftFactory providing:
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 Elasticsearch Search System Documentation 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
...
- `sort` is validated and currently supports: `relevance`, `rating`, `popularity`, `newest`.
