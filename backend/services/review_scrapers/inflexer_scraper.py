...
class InflexerScraper(BaseScraper):
    ...
    def _parse_item(self, item) -> Dict:
        ...
        try:
            ...
            # Extract source platform (Inflexer lists the original source)
            source_el = item.select_one('.platform-badge, .source, .platform, [data-platform]')
            source_platform = source_el.text.strip().lower() if source_el else 'inflexer'
