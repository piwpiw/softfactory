...
> **Purpose**: Quick reference for running performance tests and implementing optimizations.
> **Status**: 🟢 ACTIVE (관리 중)
...
- **주요 내용**: 본 문서는 SoftFactory Performance Testing & Optimization Guide 관련 핵심 명세 및 관리 포인트를 포함합니다.
- **상태**: 현재 최신화 완료 및 검토 됨.
